...
ListView lst;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lst=findViewById(R.id.listHAView);
        ...
        for(int i=0;i<health_details.length;i++){
            ...
            item.put("line1",health_details[i][1]);
            item.put("line1",health_details[i][2]);
            item.put("line1",health_details[i][3]);
            item.put("line1",health_details[i][4]);
            list.add(item);
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent it = new Intent(HealthArticlesActivity.this,HealthArticlesDeatails.class);
